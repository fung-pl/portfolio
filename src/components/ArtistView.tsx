...
const blogPosts: BlogPost[] = [
  {
    ...
    date: "August 2026",
    excerpt: "I had the privilege of participating in a mentored art residency 'Flesh as Witness' in Tipperary, Ireland. It created a supportive environment for artistic exploration, experimentation, and dialogue.",
